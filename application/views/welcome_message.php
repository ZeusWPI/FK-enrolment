...
<ul>
	...
	<li><a href="<?php echo site_url('example_api/users.csv');?>">Users</a> - get it in CSV</li>
	<li><a href="<?php echo site_url('example_api/user/id/1');?>">User #1</a> - defaulting to XML</li>
	<li><a href="<?php echo site_url('example_api/user/id/1.json');?>">User #1</a> - get it in JSON</li>
</ul>
