...
# --------------------------------------------------------------------------------------------------
# Please note: If you're subclassing Formtastic::FormBuilder in a Rails 3 project,
...
# You can add custom inputs or override parts of Formtastic by subclassing FormBuilder and
# specifying that class here.  Defaults to FormBuilder.
